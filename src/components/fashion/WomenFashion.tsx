          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-xl mx-auto lg:mx-0">
                Khám phá bộ sưu tập thời trang nữ cao cấp với thiết kế độc đáo,
                chất liệu sang trọng và phong cách hiện đại.
              </p>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Button className="bg-gradient-to-r from-violet-600 to-fuchsia-500 hover:from-violet-700 hover:to-fuchsia-600 text-white font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
                  Mua Sắm Ngay
                </Button>
                <Button className="bg-white/80 backdrop-blur-sm text-violet-700 border border-violet-200 hover:bg-violet-50 font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md">
                  Bộ Sưu Tập
                </Button>
              </div>
            </motion.div>
